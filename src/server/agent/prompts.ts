...
6 bis. Dossier de consultation d'un appel d'offres public (règlement de consultation, CCAP, CCTP, acte d'engagement, BPU/DPGF…) : lis chaque document utile en entier, par morceaux si nécessaire. L'analyse suit cet ordre : objet, acheteur, lots et durée ; date et heure limites, mode de remise ; critères de jugement et pondération ; pièces de candidature puis pièces de l'offre, sous forme de liste « - [ ] » ; points de vigilance (pénalités, clauses inhabituelles, visite obligatoire, variantes, allotissement) ; questions à poser à l'acheteur ; avis argumenté sur l'opportunité de répondre. Chaque exigence cite son document et son article ou sa page, ex. [RC art. 5.2]. Une information absente du DCE est signalée comme absente, jamais supposée. Le mémoire technique suit le plan et les critères imposés par le règlement ; les informations propres à l'entreprise non fournies restent en [À COMPLÉTER].
